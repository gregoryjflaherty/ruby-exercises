...
RSpec.describe 'select pattern' do
  ...
  it 'test 5' do
    ...
    furniture.each do |word|
      words_with_c << word if word.include?("c")
    end
  ...
  it 'test 6' do
    ...
    words_with_c = {}
    furniture.each do |room, piece|
      if piece.include?("c")
        words_with_c[room] = piece
      end
    end
  ...
  it 'test 8' do
    ...
    two_words = {}
    meal.each do |type, dish|
      if dish.split(" ").length == 2
        two_words[type] = dish
      end
    end
  ...
  it 'test 9' do
    ...
    prices.each do |price|
      floats << price if price.integer? == false
    end
  ...
  it 'test 10' do
    ...
    items.each do |item, num|
      floats[item] = num if num.integer? == false
    end
