...
RSpec.describe 'count pattern' do
  ...
  it 'test 5' do
    ...
    multiple_of_three = 0
    ages.each do |age|
      age % 3 == 0 ? multiple_of_three += 1 : nil
    end
  ...
  it 'test 7' do
    ...
    family.each do |name|
      name.length == 3 ? names_with_three_letters += 1 : nil
    end
  ...
  it 'test 9' do
    ...
    whole_numbers = 0
    prices.each do |num|
      num.to_i == num ? whole_numbers += 1 : nil
    end
